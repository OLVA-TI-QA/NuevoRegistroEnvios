...
WebUI.click(findTestObject('Object Repository/positivas/TipoEnvio/div_Hasta 1 KgEjemRopa, bisutera, reloj,len_7246c3'))

WebUI.click(findTestObject('Object Repository/positivas/TipoEnvio/span_No s el peso de mi envo'))

WebUI.verifyElementPresent(findTestObject('Object Repository/positivas/TipoEnvio/h6_CONOCE EL PESO DE TU ENVO'), 0)

WebUI.setText(findTestObject('Object Repository/positivas/TipoEnvio/input_Clcula el peso de tu envo ingresando _53efce'), 
    '150')

WebUI.click(findTestObject('Object Repository/positivas/TipoEnvio/label_LARGO (cm)'))

WebUI.setText(findTestObject('Object Repository/positivas/TipoEnvio/input_ANCHO (cm)_inputLargo'), '250')

WebUI.setText(findTestObject('Object Repository/positivas/TipoEnvio/input_LARGO (cm)_inputAlto'), '300')

WebUI.click(findTestObject('Object Repository/positivas/TipoEnvio/button_CALCULAR'))

WebUI.verifyElementText(findTestObject('Object Repository/Negativos/div_Ninguna dimensin puede superar 1 metro'), 'Ninguna dimensión puede superar 1 metro')
