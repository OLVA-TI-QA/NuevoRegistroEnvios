...
WebUI.click(findTestObject('Object Repository/Negativos/button_PAQUETE'))

WebUI.click(findTestObject('Object Repository/Negativos/button_SOBRE'))

WebUI.click(findTestObject('Object Repository/Negativos/img_CONTINUAR_btn-icon'))

WebUI.verifyElementText(findTestObject('Object Repository/Negativos/div_El valor es entre 1 y 10000'), 'El valor es entre 1 y 10000.')

WebUI.verifyElementText(findTestObject('Negativos/Page_Registro de Envos/div_Este campo es obligatorio'), 'Este campo es obligatorio.')

WebUI.verifyElementText(findTestObject('Object Repository/Negativos/div_Acepte si su envio no contiene mercanca_0e2801'), 
    'Acepte si su envio no contiene mercancía peligrosa.')

WebUI.verifyElementText(findTestObject('Object Repository/Negativos/div_Selecciona un articulo'), 'Selecciona un articulo.')
