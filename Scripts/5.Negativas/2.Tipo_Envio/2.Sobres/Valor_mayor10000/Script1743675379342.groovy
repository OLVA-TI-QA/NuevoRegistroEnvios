...
WebUI.setText(findTestObject('Object Repository/positivas/TipoEnvio/input_SOBRE_inputValorContenido'), '12000')
...
WebUI.verifyElementText(findTestObject('Object Repository/positivas/TipoEnvio/button_BOLETA'), 'El valor es entre 1 y 10000.')
