...
WebUI.verifyElementText(findTestObject('Object Repository/Negativos/Page_Registro de Envos/div_Selecciona un tipo de documento'), 
    'Selecciona un tipo de documento.')

WebUI.verifyElementText(findTestObject('Object Repository/Negativos/Page_Registro de Envos/div_Este campo es obligatorio'), 
