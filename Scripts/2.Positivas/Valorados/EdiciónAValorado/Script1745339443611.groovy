...
WebUI.setText(findTestObject('Object Repository/positivas/TipoEnvio/input_ANCHO (cm)_inputLargo'), '13')

WebUI.setText(findTestObject('Object Repository/positivas/TipoEnvio/input_LARGO (cm)_inputAlto'), '14')
...
WebUI.verifyElementText(findTestObject('Object Repository/positivas/TipoEnvio/td_LINCE'), 'LIMA - LIMA - LINCE', FailureHandling.CONTINUE_ON_FAILURE)
