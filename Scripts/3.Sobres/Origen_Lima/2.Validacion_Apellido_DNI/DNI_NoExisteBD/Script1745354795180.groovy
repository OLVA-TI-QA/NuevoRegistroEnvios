...
WebUI.setText(findTestObject('Object Repository/positivas/Sobres/input_FACTURA_inputNroDocumentoCliente'), '71735119')

WebUI.delay(3)

WebUI.verifyElementPresent(findTestObject('Object Repository/positivas/Sobres/button_GUARDAR'), 0)

WebUI.verifyElementNotClickable(findTestObject('Object Repository/positivas/Sobres/button_GUARDAR'), FailureHandling.STOP_ON_FAILURE)
