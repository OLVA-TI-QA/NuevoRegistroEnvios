...
WebUI.setText(findTestObject('Object Repository/positivas/Sobres/input_Ingresa el destino de tu envo_inputBu_d7b93a'), 'arequipa')
...
WebUI.setText(findTestObject('Object Repository/positivas/Sobres/input_SELECCIONE EL DESTINO DE SU ENVO_inpu_b5b43f'), 'Callao 1')
...
WebUI.verifyElementText(findTestObject('positivas/Sobres/td_RecojoDestino'), 'CALLAO - CALLAO - CALLAO')
