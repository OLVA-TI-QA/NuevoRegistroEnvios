...
WebUI.setText(findTestObject('Object Repository/positivas/Sobres/input_Ingresa el destino de tu envo_inputBu_d7b93a'), 'ica')
...
WebUI.setText(findTestObject('Object Repository/positivas/Sobres/input_Ingresa el destino de tu envo_inputBu_d7b93a'), 'LIMA - LIMA - ATE')
...
WebUI.setText(findTestObject('Object Repository/positivas/Sobres/input_SELECCIONE EL DESTINO DE SU ENVO_inpu_b5b43f'), 'ate ate 1')
...
WebUI.click(findTestObject('Object Repository/positivas/Sobres/img_AMAZONAS - BAGUA - BAGUA_hover-icon'))

WebUI.rightClick(findTestObject('Object Repository/positivas/Sobres/div_Deseas eliminar el envo N 1Si eliminas _9793e1'))

WebUI.verifyElementText(findTestObject('Object Repository/positivas/Sobres/small_Deseas eliminar el envo N 1'), '¿Deseas eliminar el envío N° 1')

WebUI.verifyElementText(findTestObject('Object Repository/positivas/Sobres/small_Si eliminas el envo se perdern todos _64c75c'), 
    'Si eliminas el envío se perderán todos los datos ingresados')

WebUI.click(findTestObject('Object Repository/positivas/Sobres/button_Cancelar'))

WebUI.click(findTestObject('Object Repository/positivas/Sobres/img_AMAZONAS - BAGUA - BAGUA_hover-icon'))

WebUI.click(findTestObject('Object Repository/positivas/Sobres/button_Eliminar envo'))
